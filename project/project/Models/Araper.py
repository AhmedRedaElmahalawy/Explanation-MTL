...
data = pd.read_csv('/content/project/project/dataset/Arapersonality/AraPersonality_with_text.csv')
...
embeddings = joblib.load('/content/project/project/dataset/Arapersonality/bert_embeddings_512_128_arabic.pkl')
...
class CNNExpert(nn.Module):
    def __init__(self, input_dim, num_conv_layers=2, filters=64, kernel_size=3, pool_size=2, dense_units=64, dropout=0.3):
...
def train_model(model, X_train, y_train, X_val, y_val, loss_fn, optimizer, batch_size, epochs, early_stopping, scheduler):
    ...
    for epoch in range(epochs):
        epoch_loss = L_joint  # Initialize epoch_loss
...
# Metrics
lambda_f = accuracy_score(y_test, y_pred_labels)
f1_micro_before = f1_score(y_test, y_pred_labels, average='micro')
f1_macro_before = f1_score(y_test, y_pred_labels, average='macro')
